...
5. 모두 통과하면 매일 06:20 Asia/Seoul에 독립적으로 실행되는 예약 작업을 만들어라. 각 실행은 이 저장소를 대상으로 GitHub 플러그인을 사용해 automation/codex-report-task.md 전체를 그대로 수행해야 한다. 날짜를 고정하지 말고 실행 시점의 현재 KST 날짜를 사용하라.
